...
class FloatingLyricsService : Service() {
    ...
    companion object {
        const val ACTION_SHOW = "com.example.myapplication.SHOW"
        const val ACTION_HIDE = "com.example.myapplication.HIDE"
        const val ACTION_LOCK = "com.example.myapplication.LOCK"
        const val ACTION_UNLOCK = "com.example.myapplication.UNLOCK"
        const val ACTION_MEDIA_UPDATE = "com.example.myapplication.MEDIA_UPDATE"
        const val ACTION_IMPORT_LYRICS = "com.example.myapplication.IMPORT_LYRICS"
    }
}