...
our %config = (
    ...
    "ASFLAGS" => [],
    "CC" => "/opt/android-sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/clang",
    "CFLAGS" => [
        "-Wall -O3",
        "-O2",
        "-ffunction-sections",
    ...
    "OBJCOPY" => "objcopy",
    "PERL" => "/usr/bin/perl",
    "RANLIB" => "/opt/android-sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
    "RC" => "windres",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30600",
    ...
    "options" => "--prefix=/mnt/data/andsi/android-floating-lyrics-main/lyrics-core/target/x86_64-linux-android/release/build/openssl-sys-e6a739a4814bbdfe/out/openssl-build/install --openssldir=/usr/local/ssl --libdir=lib -O2 -DANDROID -ffunction-sections -fdata-sections -fPIC -m64 --target=x86_64-linux-android -w --target=x86_64-linux-android21 no-acvp-tests no-allocfail-tests no-apps no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-camellia no-capieng no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-demos no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-hqinterop no-idea no-jitter no-ktls no-lms no-loadereng no-md2 no-module no-msan no-pie no-rc5 no-sctp no-seed no-shared no-ssl3 no-ssl3-method no-sslkeylog no-stdio no-tests no-tfo no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "2",
    "perl_archname" => "x86_64-linux-thread-multi",
    "perl_cmd" => "/usr/bin/perl",
    "perl_version" => "5.42.0",
    "perlargv" => [
        "--prefix=/mnt/data/andsi/android-floating-lyrics-main/lyrics-core/target/x86_64-linux-android/release/build/openssl-sys-e6a739a4814bbdfe/out/openssl-build/install",
        "--openssldir=/usr/local/ssl",
        "no-shared",
        "no-module",
        "no-tests",
...
unless (caller) {
    ...
    use lib '/mnt/data/andsi/android-floating-lyrics-main/lyrics-core/target/x86_64-linux-android/release/build/openssl-sys-e6a739a4814bbdfe/out/openssl-build/build/src/util/perl';
    use OpenSSL::fallback '/mnt/data/andsi/android-floating-lyrics-main/lyrics-core/target/x86_64-linux-android/release/build/openssl-sys-e6a739a4814bbdfe/out/openssl-build/build/src/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/mnt/data/andsi/android-floating-lyrics-main/lyrics-core/target/x86_64-linux-android/release/build/openssl-sys-e6a739a4814bbdfe/out/openssl-build/build/src/Configurations';
        use gentemplate;
